      ...
      <svg width={size} height={size} fill="none" {...props}>
        <g clipPath="url(#change-experience_svg__a)">
          ...
          <g mask="url(#change-experience_svg__a)">
            ...
            <path
              fill={color}
              d="M19.485 3.934l.003 1.372h.898l.004-1.166s-.013-.07-.03-.106l-.028-.082s-.075 0-.1-.009-.082-.007-.082-.007zM9.112 22.636A.4.4 0 018.8 22.5a.437.437 0 010-.628l2.246-2.248a.435.435 0 01.628 0 .44.44 0 010 .63L9.428 22.5a.4.4 0 01-.315.135"
            />
            <path
              fill={color}
